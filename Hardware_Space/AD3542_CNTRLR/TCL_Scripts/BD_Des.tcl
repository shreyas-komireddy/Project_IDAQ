...
################################################################
# This is a generated script based on design: AD3542_SYS
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ad3542_cs_0 [ create_bd_port -dir O ad3542_cs_0 ]
  set ad3542_ldac_0 [ create_bd_port -dir O ad3542_ldac_0 ]
  set ad3542_rst_0 [ create_bd_port -dir O -type rst ad3542_rst_0 ]
  set ad3542_sclk_0 [ create_bd_port -dir O ad3542_sclk_0 ]
  set ad3542_sdi_0 [ create_bd_port -dir O ad3542_sdi_0 ]
  set ad3542_sdo_0 [ create_bd_port -dir I ad3542_sdo_0 ]
  ...
  # Create instance: AD3542_CTRLR_0, and set properties
  set block_name AD3542_CTRLR
  set block_cell_name AD3542_CTRLR_0
  if { [catch {set AD3542_CTRLR_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AD3542_CTRLR_0 eq "" } {
