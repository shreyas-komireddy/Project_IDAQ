...
--Date        : Tue Mar  3 17:13:27 2026
--Host        : DSPL-LAB-2-TEF running 64-bit major release  (build 9200)
--Command     : generate_target AD7328_CMN_AXISYS_wrapper.bd
--Design      : AD7328_CMN_AXISYS_wrapper
...
entity AD7328_CMN_AXISYS_wrapper is
  port (
...
end AD7328_CMN_AXISYS_wrapper;

architecture STRUCTURE of AD7328_CMN_AXISYS_wrapper is
  component AD7328_CMN_AXISYS is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component AD7328_CMN_AXISYS;
begin
AD7328_CMN_AXISYS_i: component AD7328_CMN_AXISYS
     port map (
