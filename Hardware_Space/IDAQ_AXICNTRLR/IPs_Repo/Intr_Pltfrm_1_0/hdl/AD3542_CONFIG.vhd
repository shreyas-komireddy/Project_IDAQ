          ...
          -- WRT_REGB: Write INTERFACE_CONFIG_B (mode register)
           when WRT_REGB =>
            ...
            if spi_done = '1' then
               ...
               --dac1_dta <= x"000018" & "00" & config_dta(1 downto 0) & "00" & config_dta(1 downto 0); 
               --dac2_dta <= x"000018" & "00" & config_dta(9 downto 8) & "00" & config_dta(9 downto 8);
               --dac3_dta <= x"000018" & "00" & config_dta(17 downto 16) & "00" & config_dta(17 downto 16);
               --dac4_dta <= x"000018" & "00" & config_dta(25 downto 24) & "00" & config_dta(25 downto 24);
               dac1_dta <= x"000018" & "00" & config_dta(4) & config_dta(0) & "00" & config_dta(4) & config_dta(0);
               dac2_dta <= x"000018" & "00" & config_dta(12) & config_dta(8) & "00" & config_dta(12) & config_dta(8);
               dac3_dta <= x"000018" & "00" & config_dta(20) & config_dta(16) & "00" & config_dta(20) & config_dta(16);
               dac4_dta <= x"000018" & "00" & config_dta(28) & config_dta(24) & "00" & config_dta(28) & config_dta(24);
            end if;
...
--               dac1_dta <= x"000019" & '0' & config_dta(7 downto 5)   & '0' & config_dta(4 downto 2);
--               dac2_dta <= x"000019" & '0' & config_dta(15 downto 13) & '0' & config_dta(12 downto 10);
--               dac3_dta <= x"000019" & '0' & config_dta(23 downto 21) & '0' & config_dta(20 downto 18);
--               dac4_dta <= x"000019" & '0' & config_dta(31 downto 29) & '0' & config_dta(28 downto 26);
               dac1_dta <= x"000019" & '0' & config_dta(7 downto 5)   & '0' & config_dta(3 downto 1);
               dac2_dta <= x"000019" & '0' & config_dta(15 downto 13) & '0' & config_dta(11 downto 9);
               dac3_dta <= x"000019" & '0' & config_dta(23 downto 21) & '0' & config_dta(19 downto 17);
               dac4_dta <= x"000019" & '0' & config_dta(31 downto 29) & '0' & config_dta(27 downto 25);
            end if;
